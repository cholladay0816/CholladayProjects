    ...
    <div class="max-w-7xl min-h-screen mx-auto py-20 text-black">
        ...
        <div class="max-w-sm text-white mx-auto">
            ...
            <div class="bg-white object-end rounded-b">
                <div class="rounded-t bg-gray-300 p-5">
                    <h2 class="text-4xl font-bold text-center">Contact Information</h2>
                    <h3 class="text-xl font-semibold text-gray-700 text-center">For business inquiries, please contact me through the following
